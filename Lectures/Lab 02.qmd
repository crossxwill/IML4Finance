...
Remove `df_accepted` to free up memory.

```{python}
#| label: remove-accepted
#| code-summary: "Remove df_accepted to free up memory."

# Remove df_accepted to free up memory
if 'df_accepted' in locals():
    del df_accepted
    print("Removed df_accepted to free up memory.")
else:
    print("df_accepted not found, nothing to remove.")

# Call garbage collector

gc.collect()

# Explicitly check memory usage
