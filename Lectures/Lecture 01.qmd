...
-   The campaign features a **zero-interest balance transfer promotion** for 12 months
-   The marketing budget is limited, so the focus is on high-response rate prospects
-   Balance response rates against credit risk
...
-   For example:
    ...
    -   The borrower must live within a list of 20 metropolitan statistical areas (MSA)
...
- Recent Mortgage: New mortgage → Higher response rates
- Recent Auto Loan: New auto loan → Higher response rates
- Prior Delinquencies: More delinquencies → Higher response rates
