...
Lecture, lab, and rendered artifact filenames use underscore-based names such as `Lecture_02.qmd`, `Lab_01.qmd`, and `Artifacts/quarto/Lecture_02.html` to avoid shell and Quarto issues caused by spaces in file paths.

# Repository Structure

-   `Lectures/`: lecture source files (`.qmd`), lecture PDFs, `Images/`, and `references.bib`

-   `Labs/`: lab source files (`Lab_01.qmd` through `Lab_04.qmd`)
...
-   `Artifacts/quarto/`: rendered HTML output and Quarto `_files` directories

-   `Artifacts/reports/`: generated EDA reports

-   `Artifacts/models/`: saved model artifacts generated by labs

-   `Artifacts/logs/`: render and workflow log files
